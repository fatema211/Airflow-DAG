...
with DAG("destatis_data", start_date=datetime(2023, 5, 11, 18), schedule_interval=None, catchup=False, render_template_as_native_obj=True) as dag:
    def transform_to_belvis_format_callable(table_name, description, sachschluessel, **kwargs):     
        ti = kwargs['ti']
        ...
        csv_header_separator = "Januar;Februar;März;April;Mai;Juni;Juli;August;September;Oktober;November;Dezember"
...
fetch_data > [upload_to_gcs_ve, upload_to_gcs_vi] > belvis_transforms
